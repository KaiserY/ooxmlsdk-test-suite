macro_rules! sdk_snippet {
    ($file:literal) => {
        include_str!(concat!(
            "../../../fixtures/Open-XML-SDK/test/DocumentFormat.OpenXml.Tests/snippets/",
            $file
        ))
    };
}

macro_rules! sdk_asset_xml {
    ($file:literal) => {
        include_str!(concat!(
            "../../../fixtures/Open-XML-SDK/test/DocumentFormat.OpenXml.Tests.Assets/assets/TestFiles/extracted-xml/",
            $file
        ))
    };
}
...
pub const WORDPROCESSING_PARAGRAPH_XML: &str = sdk_snippet!("wordprocessing_paragraph.xml");
...
pub const WORDPROCESSING_PARAGRAPH_RSID_P_002_XML: &str =
    sdk_snippet!("wordprocessing_paragraph_rsid_p_002.xml");
...
pub const WORDPROCESSING_PARAGRAPH_RSID_ORDER_1_XML: &str =
    sdk_snippet!("wordprocessing_paragraph_rsid_order_1.xml");

// Source: test/DocumentFormat.OpenXml.Tests/OpenXmlElementEqualityTest.cs :: AttributeOrderingTest
pub const WORDPROCESSING_PARAGRAPH_RSID_ORDER_2_XML: &str =
    sdk_snippet!("wordprocessing_paragraph_rsid_order_2.xml");
...
pub const WORDPROCESSING_PARAGRAPH_SDT_THEN_RUN_XML: &str =
    sdk_snippet!("wordprocessing_paragraph_sdt_then_run.xml");

// Source: test/DocumentFormat.OpenXml.Tests/OpenXmlElementEqualityTest.cs :: ChildrenOrderingDifferentChildren
pub const WORDPROCESSING_PARAGRAPH_RUN_THEN_SDT_XML: &str =
    sdk_snippet!("wordprocessing_paragraph_run_then_sdt.xml");
...
pub const WORDPROCESSING_PARAGRAPH_ONLY_RUN_XML: &str =
    sdk_snippet!("wordprocessing_paragraph_only_run.xml");
...
pub const WORDPROCESSING_PARAGRAPH_RUN_1_XML: &str =
    sdk_snippet!("wordprocessing_paragraph_run_1.xml");

// Source: test/DocumentFormat.OpenXml.Tests/ofapiTest/OpenXmlElementTest.cs :: TextOuterXmlTest
pub const WORDPROCESSING_TEXT_XML: &str = sdk_snippet!("wordprocessing_text.xml");

// Source: test/DocumentFormat.OpenXml.Tests/ofapiTest/OpenXmlReaderTest.cs :: PartReaderMiscNodeTest
pub const WORDPROCESSING_DOCUMENT_XML: &str = sdk_snippet!("wordprocessing_document.xml");
...
pub const WORDPROCESSING_DOCUMENT_TWO_PARAGRAPHS_XML: &str =
    sdk_snippet!("wordprocessing_document_two_paragraphs.xml");
...
pub const WORDPROCESSING_DOCUMENT_WHITESPACE_TEXT_XML: &str =
    sdk_snippet!("wordprocessing_document_whitespace_text.xml");
...
pub const WORDPROCESSING_DOCUMENT_FORMATTED_XML: &str =
    sdk_snippet!("wordprocessing_document_formatted.xml");
...
pub const WORDPROCESSING_DOCUMENT_TRAILING_WHITESPACE_XML: &str =
    sdk_snippet!("wordprocessing_document_trailing_whitespace.xml");
...
pub const WORDPROCESSING_DOCUMENT_TRAILING_COMMENT_XML: &str =
    sdk_snippet!("wordprocessing_document_trailing_comment.xml");
...
pub const WORDPROCESSING_DOCUMENT_HYPERLINK_XML: &str =
    sdk_asset_xml!("wordprocessing_document_hyperlink.xml");
...
pub const WORDPROCESSING_DOCUMENT_PLAIN_XML: &str =
    sdk_asset_xml!("wordprocessing_document_plain.xml");
...
pub const WORDPROCESSING_DOCUMENT_HELLO_WORLD_XML: &str =
    sdk_asset_xml!("wordprocessing_document_hello_world.xml");
...
pub const WORDPROCESSING_DOCUMENT_HELLO_O14_XML: &str =
    sdk_asset_xml!("wordprocessing_document_hello_o14.xml");
...
pub const WORDPROCESSING_DOCUMENT_COMMENTS_XML: &str =
    sdk_asset_xml!("wordprocessing_document_comments.xml");

// Source: test/DocumentFormat.OpenXml.Tests.Assets/assets/TestFiles/Comments.docx :: word/comments.xml
pub const WORDPROCESSING_COMMENTS_XML: &str = sdk_asset_xml!("wordprocessing_comments.xml");
...
pub const WORDPROCESSING_DOCUMENT_SIMPLE_SDT_XML: &str =
    sdk_asset_xml!("wordprocessing_document_simple_sdt.xml");
...
pub const WORDPROCESSING_DOCUMENT_DOCUMENT_XML: &str =
    sdk_asset_xml!("wordprocessing_document_document.xml");

// Source: test/DocumentFormat.OpenXml.Tests.Assets/assets/TestFiles/Spreadsheet.xlsx :: xl/workbook.xml
pub const SPREADSHEET_WORKBOOK_XML: &str = sdk_asset_xml!("spreadsheet_workbook.xml");
...
pub const SPREADSHEET_WORKSHEET_COMPLEX01_SHEET1_XML: &str =
    sdk_asset_xml!("spreadsheet_worksheet_complex01_sheet1.xml");

// Source: test/DocumentFormat.OpenXml.Tests.Assets/assets/TestFiles/Presentation.pptx :: ppt/presentation.xml
pub const PRESENTATION_PRESENTATION_XML: &str = sdk_asset_xml!("presentation_presentation.xml");
...
pub const PRESENTATION_NON_VISUAL_DRAWING_PROPERTIES_XML: &str =
    sdk_snippet!("presentation_non_visual_drawing_properties.xml");
...
pub const EXTENDED_PROPERTIES_TITLES_OF_PARTS_XML: &str =
    sdk_snippet!("extended_properties_titles_of_parts.xml");

// Source: test/DocumentFormat.OpenXml.Tests/ofapiTest/OpenXmlCompositeElementTest.cs :: Bug225919Test
pub const CUSTOM_PROPERTIES_BOOL_XML: &str = sdk_snippet!("custom_properties_bool.xml");
...
pub const OPC_CORE_PROPERTIES_HELLO_WORLD_XML: &str =
    sdk_asset_xml!("opc_core_properties_hello_world.xml");
...
pub const OPC_CORE_PROPERTIES_MORE_DOC_PROPS_XML: &str =
    sdk_asset_xml!("opc_core_properties_more_doc_props.xml");
...
pub const EXTENDED_PROPERTIES_MORE_DOC_PROPS_XML: &str =
    sdk_asset_xml!("extended_properties_more_doc_props.xml");
...
pub const SPREADSHEET_SHARED_STRING_TABLE_XML: &str =
    sdk_snippet!("spreadsheet_shared_string_table.xml");
...
pub const SPREADSHEET_SHARED_STRING_TABLE_EMPTY_XML: &str =
    sdk_snippet!("spreadsheet_shared_string_table_empty.xml");

// Source: test/DocumentFormat.OpenXml.Tests/ofapiTest/BugRegressionTest.cs :: Bug743591
pub const SPREADSHEET_COLOR_SCALE_XML: &str = sdk_snippet!("spreadsheet_color_scale.xml");
...
pub const SPREADSHEET_CELL_VALUE_DOUBLE_XML: &str =
    sdk_snippet!("spreadsheet_cell_value_double.xml");
...
pub const SPREADSHEET_CELL_VALUE_DOUBLE_EXPONENTIAL_XML: &str =
    sdk_snippet!("spreadsheet_cell_value_double_exponential.xml");
...
pub const SPREADSHEET_CELL_VALUE_INT_EXPONENTIAL_XML: &str =
    sdk_snippet!("spreadsheet_cell_value_int_exponential.xml");
...
pub const SPREADSHEET_CELL_VALUE_BOOLEAN_XML: &str =
    sdk_snippet!("spreadsheet_cell_value_boolean.xml");

// Source: test/DocumentFormat.OpenXml.Tests/Spreadsheet/CellValueTests.cs :: CellIntTest
pub const SPREADSHEET_CELL_VALUE_INT_XML: &str = sdk_snippet!("spreadsheet_cell_value_int.xml");
...
pub const SPREADSHEET_CELL_VALUE_DECIMAL_EXPONENTIAL_XML: &str =
    sdk_snippet!("spreadsheet_cell_value_decimal_exponential.xml");
...
pub const SPREADSHEET_CELL_VALUE_DATETIME_XML: &str =
    sdk_snippet!("spreadsheet_cell_value_datetime.xml");
...
pub const SPREADSHEET_CELL_VALUE_DATETIME_OFFSET_XML: &str =
    sdk_snippet!("spreadsheet_cell_value_datetime_offset.xml");

pub const DOC_SAMPLES_DIR: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../../corpus/Open-XML-SDK/test/DocumentFormat.OpenXml.Tests.Assets/assets/TestFiles"
);
