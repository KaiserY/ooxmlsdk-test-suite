...
pub mod office_corpus_fonts;
pub mod office_golden;
pub mod office_golden_corpus;
pub mod office_pdf_campaign;
pub mod pdf_extract;
pub mod pdf_fragment;
pub mod render;

use std::path::{Path, PathBuf};

pub use office_corpus_fonts::{
    CorpusFontReferenceReport, LocalFontCandidateReport, scan_campaign_font_references,
    scan_local_font_candidates,
};
...
pub use office_pdf_campaign::{
    ...
    audit_campaign, audit_campaign_pilot, audit_one, audit_one_with_artifacts, convert_campaign,
    generate_campaign_assignments, read_plan, validate_assignments, write_plan,
};
pub use pdf_extract::{
...
pub use pdf_fragment::canonical_pdf_fragment_snapshot;
