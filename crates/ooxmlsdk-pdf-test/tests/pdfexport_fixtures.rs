use ooxmlsdk_pdf_test::{
    PdfBounds, PdfSummary, assert_pdf_rect_close, libreoffice_fixture, pdf_page_count_for_fixture,
    pdf_summary_for_fixture, pdf_summary_for_fixture_with_options,
};
...
fn pdfexport_fixture_tdf131728_preserves_bookmark_order() {
    let summary = render_summary("sw/qa/extras/uiwriter/data/tdf131728.docx");
    assert_eq!(summary.page_count, 1);
    assert_eq!(
        summary.outlines,
        [
